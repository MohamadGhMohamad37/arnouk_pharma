...
@section('title','Edit About Arnouk Pharma')
@section('style')
<style>
    .drop-area {
...
<div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <h4 class="header-title">Edit Arnouk Pharma About</h4>
            
                                            <form class="custom-validation" action="{{ route('about.update', ['about' => $about->id, 'lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group mb-3">
                                                    <label class="mb-2">Name English</label>
                                                    <input type="text" name="name_en" class="form-control" value="{{ $about->name_en }}" required />
                                                    </div>

                                                <div class="form-group mb-3">
                                                    <label class="mb-2">Name Arabic</label>
                                                    <input type="text" name="name_ar" class="form-control" value="{{ $about->name_ar }}" required />
                                                    </div>
                                                <div class="form-group mb-3">
                                                    <label class="mb-2">Textarea</label>
                                                    <div>
                                                    <textarea id="disc_en" class="form-control" name="description_en">{!! $about->description_en !!}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label class="mb-2">Textarea</label>
                                                    <div>
                                                    <textarea id="disc_ar" class="form-control" name="description_ar">{!! $about->description_ar !!}</textarea>
                                                    </div>
                                                </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div id="drop-area" class="drop-area">
                                                            ...
                                                            @if($about->main_image)
                                                                <img src="{{ asset($about->main_image) }}" style="max-width: 100px; margin-bottom:10px;" />
                                                            @endif
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div id="video-drop-area" class="drop-area">
                                                            <p>{{ __('messages.drag_drop_video') }}</p>
                                                            <input type="file" name="video" id="video" class="form-control" style="display: none;" accept="video/*" >
                                                            <video id="video-preview" controls style="display: none; margin-top: 10px; max-width: 100%;"></video>
                                                            @if($about->video)
                                                                <video src="{{ asset($about->video) }}" controls style="max-width: 200px; display:block; margin-top:10px;"></video>
                                                            @endif
