...
@section('title','Create About Arnouk Pharma')
@section('style')
<style>
    .drop-area {
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="custom-validation" action="{{ route('about.store', ['lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div>
                                                     <textarea id="disc_en" class="form-control" name="description_en"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label class="mb-2">Textarea</label>
                                                    <div>
                                                     <textarea id="disc_ar" class="form-control" name="description_ar"></textarea>
                                                    </div>
                                                </div>
