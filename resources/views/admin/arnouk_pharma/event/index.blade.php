                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <h4 class="header-title">Event Arnouk Pharma</h4>
                                                <a href="{{ route('event_arnouk_pharma.create', ['lang' => app()->getLocale()]) }}" class="btn btn-success">
                                                    + Create
                                                </a>
                                            </div>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>date: {{ $event->event_date }} Time: {{ $event->event_time }}</td>
                                                    <td>
                                                    <a href="{{ route('event_arnouk_pharma.edit', ['event_arnouk_pharma' => $event->id, 'lang' => app()->getLocale()]) }}" class="btn btn-warning btn-sm">
                                                        Edit
                                                    </a>
                                                    <a href="{{ route('event_arnouk_pharma.show', ['event_arnouk_pharma' => $event->id, 'lang' => app()->getLocale()]) }}" class="btn btn-info btn-sm">
                                                        Show
                                                    </a>
                                                    <form action="{{ route('event_arnouk_pharma.destroy', ['event_arnouk_pharma' => $event->id, 'lang' => app()->getLocale()]) }}" method="POST" style="display:inline-block;" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
