...
@section('title','Event Arvnouk Pharma Show')
@section('style')
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="container mt-5">
                            <h2>{{ $event_arnouk_pharma->{'name_' . app()->getLocale()} }}</h2>

                            <p><strong>Description:</strong></p>
                            <p>{!! $event_arnouk_pharma->{'description_' . app()->getLocale()} !!}</p>

                            @if ($event_arnouk_pharma->image)
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="gallery-box mt-4">
                                    <a class="gallery-popup" href="{{ asset($event_arnouk_pharma->image) }}" title="Main Image">
                                        <img class="gallery-demo-img img-fluid mx-auto" src="{{ asset($event_arnouk_pharma->image) }}" alt="1" />
                            ...
                            @if ($event_arnouk_pharma->gallery_images && is_array(json_decode($event_arnouk_pharma->gallery_images)))
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    <div class="carousel-indicators">
                                                        @foreach (json_decode($event_arnouk_pharma->gallery_images) as $index => $img)
                                                            <button type="button"
                            ...
                            <a href="{{ route('event_arnouk_pharma.index', ['lang' => app()->getLocale()]) }}" class="btn btn-secondary">Back</a>
                        </div>
                        </div>
                    </div>
                </div>
