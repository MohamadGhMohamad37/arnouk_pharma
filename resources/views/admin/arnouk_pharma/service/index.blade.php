                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $service->{'description_' . app()->getLocale()} }}</td>
                                                    <td>{{ $service->created_at }}</td>
                                                    <td>
                                                    <a href="{{ route('service.edit', ['service' => $service->id, 'lang' => app()->getLocale()]) }}" class="btn btn-warning btn-sm">
                                                        Edit
                                                    </a>
                                                    <a href="{{ route('service.show', ['service' => $service->id, 'lang' => app()->getLocale()]) }}" class="btn btn-info btn-sm">
                                                        Show
                                                    </a>
                                                    <form action="{{ route('service.destroy', ['service' => $service->id, 'lang' => app()->getLocale()]) }}" method="POST" style="display:inline-block;" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
