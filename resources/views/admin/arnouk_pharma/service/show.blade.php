                        ...
                        <div class="container mt-5">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="gallery-box mt-4">
                                    <a class="gallery-popup" href="{{ asset($service->main_image) }}" title="Main Image">
                                        <img class="gallery-demo-img img-fluid mx-auto" src="{{ asset($service->main_image) }}" alt="1" />
                            ...
                            <a href="{{ route('service.index', ['lang' => app()->getLocale()]) }}" class="btn btn-secondary">Back</a>
                        </div>
                        </div>
                    </div>
                </div>
