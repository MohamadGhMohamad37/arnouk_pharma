            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="custom-validation" action="{{ route('service.update', ['service' => $service->id, 'lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="drop-area" class="drop-area">
                                    ...
                                    <input type="file" name="main_image" id="image" class="form-control" style="display: none;" accept="image/*">
                                    @if($service->main_image)
                                        <img id="image-preview" src="{{ asset($service->main_image) }}" alt="Image Preview" style="margin-top: 10px; max-width: 100%;">
                                    @else
