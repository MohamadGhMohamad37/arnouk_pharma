                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <h4 class="header-title">Category Arnouk Pharma</h4>
                                                <a href="{{ route('category_arnouk_pharma.create', ['lang' => app()->getLocale()]) }}" class="btn btn-success">
                                                    + Create
                                                </a>
                                            </div>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="{{ route('category_arnouk_pharma.edit', ['category_arnouk_pharma' => $category->id, 'lang' => app()->getLocale()]) }}" class="btn btn-warning btn-sm">
                                                        Edit
                                                    </a>
                                                    <a href="{{ route('category_arnouk_pharma.show', ['category_arnouk_pharma' => $category->id, 'lang' => app()->getLocale()]) }}" class="btn btn-info btn-sm">
                                                        Show
                                                    </a>
                                                    <form action="{{ route('category_arnouk_pharma.destroy', ['category_arnouk_pharma' => $category->id, 'lang' => app()->getLocale()]) }}" method="POST" style="display:inline-block;" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
