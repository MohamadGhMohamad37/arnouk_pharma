...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Create category_arnouk_pharma</h4>

                <form class="custom-validation" action="{{ route('category_arnouk_pharma.store', ['lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
