                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="container mt-5">
                            <h2>{{ $products_arnouk_pharma->{'name_' . app()->getLocale()} }}</h2>

                            <p><strong>Description:</strong></p>
                            <p>{!! $products_arnouk_pharma->{'description_' . app()->getLocale()} !!}</p>

                            @if ($products_arnouk_pharma->main_image)
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="gallery-box mt-4">
                                    <a class="gallery-popup" href="{{ asset($products_arnouk_pharma->main_image) }}" title="Main Image">
                                        <img class="gallery-demo-img img-fluid mx-auto" src="{{ asset($products_arnouk_pharma->main_image) }}" alt="1" />
                            ...
                            @if ($products_arnouk_pharma->images && is_array(json_decode($products_arnouk_pharma->images)))
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-body">
                            ...
                            <a href="{{ route('products_arnouk_pharma.index', ['lang' => app()->getLocale()]) }}" class="btn btn-secondary">Back</a>
                        </div>
                        </div>
                    </div>
                </div>
