            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="custom-validation" action="{{ route('products_arnouk_pharma.update', ['lang' => app()->getLocale(), $products_arnouk_pharma->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="category_id" class="form-control" required>
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ $products_arnouk_pharma->category_id == $category->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name_en" class="form-control" required value="{{ $products_arnouk_pharma->name_en }}" />
                            </div>

                            <!-- Name Arabic -->
                            <div class="form-group mb-3">
                                <label class="mb-2">Name Arabic</label>
                                <input type="text" name="name_ar" class="form-control" required value="{{ $products_arnouk_pharma->name_ar }}" />
                            </div>

                            <!-- Description English -->
                            <div class="form-group mb-3">
                                <label class="mb-2">Description English</label>
                                <textarea class="form-control" id="disc_en" name="description_en">{!! $products_arnouk_pharma->description_en !!}</textarea>
                            </div>

                            <!-- Description Arabic -->
                            <div class="form-group mb-3">
                                <label class="mb-2">Description Arabic</label>
                                <textarea class="form-control" id="disc_ar" name="description_ar">{!! $products_arnouk_pharma->description_ar !!}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="drop-area" class="drop-area">
                                    ...
                                    <img id="image-preview" src="{{ asset($products_arnouk_pharma->main_image) }}" alt="Image Preview" style="margin-top: 10px; max-width: 100%;">
                                </div>
                            </div>

                            <!-- Existing Multi Images -->
                            <div class="form-group">
                                <label>Existing Images</label>
                                <div class="multi-images-preview">
                                    @foreach (json_decode($products_arnouk_pharma->images) as $index => $img)
                            ...
                            <!-- Multiple New Images -->
                            <div class="form-group">
                                <label for="multi_images">Upload New Images</label>
